        ...
        if text_lower == "next":
            ...
            if state == 'list1':
                ...
                await m.reply_text(
                    ...
                    "‣ Custom mapping: send `1=4, 3=2, 5-10=3,5,7-15`\n"
                ...
                try:
                    ...
                    if len(chunks) > 1:
                        ...
                        for i in range(1, len(chunks)):
                            right_and_next_left = chunks[i]
                            if i == len(chunks) - 1:
                                right_str = right_and_next_left
                                next_left_str = ""
                            else:
                                sub_parts = right_and_next_left.split(',')
                                next_left_str = sub_parts[-1]
                                right_str = ','.join(sub_parts[:-1])
                            ...
                            for part in left_str.split(','):
                                ...
                                if '-' in part:
                                    ...
                                    left_indices.extend(list(range(s-1, e)))
                                else:
                                    left_indices.append(int(part)-1)
                            ...
                            for part in right_str.split(','):
                                ...
                                if '-' in part:
                                    s, e = map(int, part.split('-'))
                                    right_indices.extend(list(range(s-1, e)))
                                else:
                                    right_indices.append(int(part)-1)
